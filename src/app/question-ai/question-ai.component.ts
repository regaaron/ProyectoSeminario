...
@Component({
  selector: 'app-question-ai',
  standalone: true,
  imports: [CommonModule,FormsModule],
  templateUrl: './question-ai.component.html',
  styleUrl: './question-ai.component.css'
})
export class QuestionAIComponent implements OnInit{
   preguntas: any[] = [];

  constructor(private preguntasService: AdminPreguntasService,private http: HttpClient) {}
...
aceptarPregunta(id: number) {
  Swal.fire({
    title: "¿Aceptar pregunta?",
    text: "Se moverá a la base final.",
    showCancelButton: true,
